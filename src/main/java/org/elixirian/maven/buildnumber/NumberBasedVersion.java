 ...
 */
public class NumberBasedVersion implements Version
{
  public static final NumberBasedVersion EMPTY_VERSION = new NumberBasedVersion("",
      ImmutableLists.<Integer> emptyList(), 0);
  ...
  private NumberBasedVersion(final String version, final ImmutableList<Integer> versionNumbers, final int hashCode)
  {
  ...
  public int compareTo(final Version version)
  {
    ...
    for (int i = 0; i < length; i++)
    {
      ...
      final Integer thatNumber = version.getVersionNumbers().get(i);
    ...
    {
      for (final Integer v : version.getVersionNumbers().subList(thisLength, thatLength))
      {
        @SuppressWarnings("boxing")
        final int n = v;
        if (0 != n)
  ...
  public boolean equals(final Object version)
  {
    ...
    final NumberBasedVersion that = castIfInstanceOf(NumberBasedVersion.class, version);
    return null != that && 0 == compareTo(that);
  }

  public static ImmutableList<Integer> getVersionNumbers(final String version, final String separator)
  {
    /* @formatter:off */
  ...
  public static NumberBasedVersion newInstance(final String version, final String separator)
  {
    ...
    final ImmutableList<Integer> list = 0 <= lastNoneZero ?
        versionNumbers.subList(0, lastNoneZero + 1) :
          versionNumbers;
        
    /* @formatter:off */
    final int hashCode = list.hashCode();
        /* @formatter:on */
    return new NumberBasedVersion(trimmedVersion, versionNumbers, hashCode);
  }

  public static NumberBasedVersion newInstance(final String version)
  {
